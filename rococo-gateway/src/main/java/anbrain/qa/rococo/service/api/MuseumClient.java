...
public class MuseumClient {
    ...
    public RestPage<MuseumJson> getAll(@NonNull Pageable pageable) {
        try (InputStream inputStream = new ClassPathResource("pageJson/get_all_museum.json").getInputStream()) {
            ObjectMapper mapper = new ObjectMapper();
            List<MuseumJson> paintings = mapper.readValue(inputStream, new TypeReference<>() {});
            ...
            List<MuseumJson> pageContent = paintings.subList(start, end);
