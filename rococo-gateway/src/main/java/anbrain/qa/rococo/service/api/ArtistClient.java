...
public class ArtistClient {
    ...
    public RestPage<ArtistJson> getAll(@NonNull Pageable pageable) {
        try (InputStream inputStream = new ClassPathResource("pageJson/get_all_artist.json").getInputStream()) {
            ObjectMapper mapper = new ObjectMapper();
            List<ArtistJson> paintings = mapper.readValue(inputStream, new TypeReference<>() {});
            ...
            List<ArtistJson> pageContent = paintings.subList(start, end);
