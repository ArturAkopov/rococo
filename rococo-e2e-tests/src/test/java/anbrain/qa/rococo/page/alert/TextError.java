...
public enum TextError {
    ...
    THE_CITY_NAME_CANNOT_BE_SHORTER_THAN_3_CHARACTERS("Город не может быть короче 3 символов"),
    THE_CITY_NAME_CANNOT_BE_LONGER_THAN_255_CHARACTERS("Город не может быть длиннее 255 символов"),
    THE_DESCRIPTION_CANNOT_BE_SHORTER_THAN_10_CHARACTERS("Описание не может быть короче 10 символов"),
    THE_DESCRIPTION_CANNOT_BE_LONGER_THAN_2000_CHARACTERS("Описание не может быть длиннее 2000 символов"),
